...
router.post('/createcategory',auth(EndPoints.Create),fileUpload(FileValue.image).single('image'),Validation(schema.createCategorySchema),CategoryController.CreateCategory);
...
router.patch('/updatecategory/:id',auth(),fileUpload(FileValue.image).single('image'),Validation(schema.UpdateSchema),CategoryController.UpdateCategories);
